...
public class Player extends B2DSprite {
	...
	/** Atualizando o sistema - anima√ß√£o e estado do jogador */
	...
	/** Movimenta√ß√£o do personagem para a direita */
	...
	/** Movimenta√ß√£o do personagem para a esquerda */
	...
	/** Movimenta√ß√£o do personagem para cima */
	public void moveUp() {
	...
	/** Movimenta√ß√£o do personagem para baixo */
	...
	/** Anima√ß√£o para o bomberman parado */
	...
	//animaÁ„o morrendo - criei este estado fantasma para a funÁao est· parado n„o sobrescreva a animaÁ„o
