...
public class Enemy3 extends B2DSprite {
	...
	private void setTextures() {
		up = Game.res.getTexture("e3up");
		down = Game.res.getTexture("e3down");
		left = Game.res.getTexture("e3left");
		right = Game.res.getTexture("e3right");
	}
