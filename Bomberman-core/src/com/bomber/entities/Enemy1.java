...
public class Enemy1 extends B2DSprite {
	...
	private void setTextures() {
		up = Game.res.getTexture("e1up");
		down = Game.res.getTexture("e1down");
		left = Game.res.getTexture("e1left");
		right = Game.res.getTexture("e1right");
	}
