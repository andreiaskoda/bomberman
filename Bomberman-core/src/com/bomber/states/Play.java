...
import com.bomber.entities.Bagura;
import com.bomber.entities.Enemy1;
import com.bomber.entities.Enemy2;
import com.bomber.entities.Enemy3;
...
public class Play extends GameState{
	...
	public Play(GameStateManager gsm){		
		...
		bagura = new Bagura(enemy1, enemy2, enemy3);
	...
	public void handleInput() {
		...
		if(GameKeys.isDown(GameKeys.RIGHT) && 
				player.estaParado() && !cl.isBlockedRight())
			player.moveRight();
		
		else if(GameKeys.isDown(GameKeys.LEFT) && 
				player.estaParado() && !cl.isBlockedLeft())
			player.moveLeft();
		
		else if(GameKeys.isDown(GameKeys.UP) && 
				player.estaParado() && !cl.isBlockedUp())
			player.moveUp();
		
		else if(GameKeys.isDown(GameKeys.DOWN) && 
				player.estaParado() && !cl.isBlockedDown())
			player.moveDown();
		
		else if(GameKeys.isPressed(GameKeys.SPACE) && player.estaParado())
			this.setBomb();
